angular.module("salono").controller("ServicesCtrl", ["$scope", "ServicesSvc", function($scope, ServicesSvc){
	...
	$scope.ServiceDetails = {
        ...
        "Pigment": ["Full Color", "Retouch Color", "Highlights", "Ombre | Sombre | Color Melt", "Color Correction: Requires a consultation", "Balayage"],
        ...
        "Indulge" : ["Full Body Waxing & Sugaring", "Full Face Waxing & Sugaring", "Brow Microblading: Requires a consultation"]
    };
